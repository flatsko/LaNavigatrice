...
const SharingGameCard = ({ onComplete, onClose }) => {
  ...
  const challenge = {
    ...
    question:
      "  Un vrai marin partage ses richesses avec ses frères des mers !",
    mission:
      "Allez chercher une boisson pour chaque membre d'une équipe adverse et apportez-leur",
  ...
  const handleStartMission = () => {
    ...
    setFeedback({
      type: "info",
      message:
        "🚀 Mission lancée ! Allez accomplir votre gage et revenez prendre une photo de validation.",
    });
  };
    ...
    try {
      ...
      const confirmed = window.confirm(
        "Avez-vous vraiment accompli votre gage ?\n\n" +
          "✅ Vous avez apporté les vivres à une équipe adverse\n" +
  ...
  const validateChallenge = () => {
    ...
    setFeedback({
      type: "success",
      message:
        "🎉 Excellent ! Vous avez accompli votre gage avec brio ! L'esprit de partage à l'état pur !",
      points: totalScore,
    });
  ...
  const handleSkip = () => {
    setFeedback({
      type: "skipped",
      message:
        "⏭️ Gage passé. Un vrai mousse n'abandonne jamais l'esprit de partage !",
      points: 0,
    });
    setIsComplete(true);
    setTimeout(() => {
  ...
  return (
    <MiniGameOverlay onClose={handleClose} isClosing={isClosing}>
      <div
        className={`enigma-card sharing-game-card ${
          isClosing ? "closing" : ""
        }`}
      ...
      >
        <div className="enigma-header">
          ...
          <div className="enigma-title">
            ...
            <p className="enigma-subtitle">
              ⚓ <strong>Gage de mousse :</strong> Montrez votre esprit de
              partage et gagnez jusqu'à <strong>800+ points bonus</strong> ! 🏆
            </p>
          </div>
        </div>
        ...
        <div className="sharing-game-content">
          ...
          {validationStep === "instructions" && (
            <div className="mission-instructions">
              <div className="instructions-box">
                <h4>📋 Instructions :</h4>
                <ol>
                  <li>🎯 Trouvez une équipe adverse</li>
                  <li>🍻 Servez à chaque membre une boisson différente</li>
                  <li>🥨 Accompagnez d'un en-cas salé pour 'éponger'</li>
                  <li>🎵 Portez un toast au Capitaine Alison</li>
                  <li>📸 Immortalisez ce moment</li>
                </ol>
                <p className="encouragement">
                  💪 <strong>Courage, mousse !</strong> L'esprit de partage est
                  la clé d'un bon équipage !
                </p>
              </div>
            </div>
          )}
          ...
          {validationStep === "photo" && (
            <div className="photo-validation">
              <div className="photo-instructions">
                ...
                <p>
                  Avez-vous accompli votre mission ? Prenez une photo avec
                  l'équipe adverse !
                </p>
                <div className="photo-tips">
                  <p>
                    <strong>💡 Conseils pour la photo :</strong>
                  </p>
                  <ul>
          ...
          {isComplete && (
            <div className="game-success">
              <h3>🎉 Gage terminé !</h3>
              <p>
                Mission : <strong>{challenge.mission}</strong>
              </p>
              {score > 0 && (
        ...
        {!isComplete && (
          <div className="enigma-actions">
            {validationStep === "instructions" && (
              <button className="submit-btn" onClick={handleStartMission}>
            ...
            <div className="skip-section">
              ...
              <p className="skip-warning">
                ⚠️ Attention : Passer ce gage vous fera perdre jusqu'à{" "}
