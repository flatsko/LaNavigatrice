    ...
    <div className="welcome-page">
      ...
      <div className="welcome-container">
        ...
        >
          ...
          >
            {currentTheme.texts.welcomeSubtitle
              .split("\n")
              .map((line, index) => (
        ...
        >
          <form onSubmit={handleSubmit} className="navigator-form">
            ...
            <motion.button
              ...
              whileHover={{
                scale: !playerName.trim() || !agreeTerms ? 1 : 1.05,
              }}
            ...
            >
              💡{" "}
              <em>
                Conseil de vieux loup de mer : Choisissez un nom qui ferait
                honneur au Capitaine Alison ! ⚓{" "}
              </em>
            </motion.p>
          </form>
        </motion.div>
                ...
                {[
                  {
                    icon: "🗺️",
                    title: "Mission",
                    text: "Découvrez les 7 plus belles destinations du capitaine Alison",
                  },
                  {
                    icon: "📱",
                    title: "QR Codes",
                  ...
                  },
                  {
                    icon: "🧩",
                    title: "Énigmes",
                    text: "Résolvez les énigmes sur les merveilles du monde pour débloquer les pays",
                  },
                  {
                    icon: "⏱️",
                    title: "Navigation",
                  ...
                  },
                  {
                    ...
                    text: "Réussisez au moins 50% des désintations pour révéler l'endroit de rêve d'Alison !",
                  },
                  {
                    icon: "🤝",
                    title: "Esprit marin",
        ...
        >
          <div className="info-cards">
            {[
              ...
              { icon: "🌍", title: "Destinations", text: "7 destinations" },
            ].map((info, index) => (
              <motion.div
                key={index}
                className="info-card"
