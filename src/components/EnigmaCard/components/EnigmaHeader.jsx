...
const EnigmaHeader = ({ enigma, onClose, attempts, successRate, isSuccess }) => (
  <div className="enigma-header">
    <button className="enigma-close-btn" onClick={onClose}>✕</button>
    ...
    {!isSuccess && (
      <div className="enigma-progress">
        <div className="attempt-counter">
          <span className={`attempts ${attempts >= GAME_RULES.MAX_ATTEMPTS_PER_ENIGMA ? 'exhausted' : ''}`}>
