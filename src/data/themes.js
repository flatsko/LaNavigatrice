...
export const THEMES = {
  TOUR_DU_MONDE: {
    ...
    gradients: {
      ...
      treasure: 'linear-gradient(135deg, #ffd700 0%, #ffc107 50%, #ff8f00 100%)',
    ...
    texts: {
      ...
      welcomeDescription: 'Embarquez pour un voyage élégant autour du monde ! Découvrez des merveilles extraordinaires, explorez les plus beaux rivages et aidez à révéler la destination de rêve du Capitaine Alison ! ⚓',
  ...
  DUNE_PAGE_A_LAUTRE: {
    ...
    gradients: {
      ...
      treasure: 'linear-gradient(135deg, #F4A460 0%, #DEB887 50%, #D2B48C 100%)', // Gradient sable et bois
    ...
    texts: {
      ...
      welcomeDescription: 'Accompagnez Alison dans son voyage de l\'Alsace vers la Charente-Maritime ! Découvrez les étapes de cette belle aventure et aidez-la à écrire une nouvelle page de sa vie ! 📖',
